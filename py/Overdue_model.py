...
train_data = train_data.drop(['상품','RRC_CD','HAC_CD','지역코드','AD_NO','주거지','주소지','ADD_YN'], axis=1)
...
impact_df.to_excel('Overdue_feature_impact.xlsx', index=False)