        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title="고객센터" id="collasible-nav-dropdown">
              <NavDropdown.Item href="/MainNotice">공지사항</NavDropdown.Item>
              <NavDropdown.Item href="/MainQnA">Q & A</NavDropdown.Item>
              <NavDropdown.Item href="/MainFaQ">자주 묻는 질문</NavDropdown.Item>
            </NavDropdown>
          </Nav>
          <Nav>
            <Nav.Link href="/LoginPage">로그인</Nav.Link>
            <Nav.Link eventKey={2} href="/JoinForm">회원가입</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
